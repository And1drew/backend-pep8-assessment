# SNAKES GAME
# Use ARROW KEYS to play, SPACE BAR
# for pausing/resuming and Esc Key for exiting

# Code courtesy of
# Sanchit Gangwar: https://gist.github.com/sanchitgangwar/2158089
...
while key != 27:
    ...
    if (snake[0][0] == 0 or snake[0][0] == 19
       or snake[0][1] == 0 or snake[0][1] == 59):
        break
